...
#code written using both the weekly pracs and from https://www.instructables.com/id/From-Data-to-Graph-a-Web-Jorney-With-Flask-and-SQL/
#by Aidan Harris
...
database = '/home/pi/Assignment_1/sensehat.db'
